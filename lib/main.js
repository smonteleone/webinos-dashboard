...
dashboard.modules.add("config", "Configuration", path.join(__dirname, '../modules/config/'));
...
dashboard.modules.add("serviceConfiguration", "Service Configuration", path.join(__dirname, '../modules/dashboard-serviceConfiguration/'));
dashboard.modules.add("serviceSharing", "Service Sharing", path.join(__dirname, '../modules/dashboard-serviceSharing/'), false);
